...
---
## Input:
[ build an app that allows individuals to hire the services of a cleaner to do home cleaning, office cleaning etc.. allows people to register and be hired by the people in their location.. clients pays the company and the company pays the staff hired.. the app name should be Oma   ASK THE USER]
## Output:
